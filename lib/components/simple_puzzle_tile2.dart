...
class SimplePuzzleTile2 extends StatefulWidget {
  final List<int> order;
  final int value;
  final Function onTap;

  const SimplePuzzleTile2({
    Key? key,
    required this.order,
    required this.value,
    required this.onTap,
  ...
  @override
  State<SimplePuzzleTile2> createState() => _SimplePuzzleTile2State();
}

class _SimplePuzzleTile2State extends State<SimplePuzzleTile2> {
  @override
